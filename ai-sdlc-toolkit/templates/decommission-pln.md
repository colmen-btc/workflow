...
> Retirement source: migration-plan `retire` rows. Gate checklist: [`checklists/decommission-gate.md`](../../ai-sdlc-toolkit/checklists/decommission-gate.md).

## Retirement Scope

| AS-IS item being retired | Component(s) | Reason |
|--------------------------|--------------|--------|
| <!-- REPLACE: ASIS-... epic/feature --> | <!-- REPLACE --> | <!-- REPLACE: replaced by ... --> |
