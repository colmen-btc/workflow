...
- Template: [`ai-sdlc-toolkit/templates/migration-plan.md`](../../templates/migration-plan.md)

## Required Workflow

1. Read [`ai-sdlc-toolkit/templates/migration-plan.md`](../../templates/migration-plan.md) and treat every `<!-- AGENT: ... -->` block as authoring rules — not text to copy.
