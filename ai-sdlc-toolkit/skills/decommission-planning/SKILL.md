...
- Template: [`ai-sdlc-toolkit/templates/decommission-plan.md`](../../templates/decommission-plan.md)

## Required Workflow

1. Read [`ai-sdlc-toolkit/templates/decommission-plan.md`](../../templates/decommission-plan.md) and treat every `<!-- AGENT: ... -->` block as authoring rules — not text to copy.
