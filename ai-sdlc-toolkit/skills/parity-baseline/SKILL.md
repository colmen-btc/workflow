...
- Template: [`ai-sdlc-toolkit/templates/parity-baseline.md`](../../templates/parity-baseline.md)

## Required Workflow

1. Read [`ai-sdlc-toolkit/templates/parity-baseline.md`](../../templates/parity-baseline.md) and treat every `<!-- AGENT: ... -->` block as authoring rules — not text to copy.
