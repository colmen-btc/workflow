...
| Input | Notes |
|-------|--------|
| **Context** | Any materials the story is built from (notes, bullets, briefs, research, threads, transcripts, metrics, screenshots, **SDLC docs** such as initiative / epic / roadmap—only when relevant). |
