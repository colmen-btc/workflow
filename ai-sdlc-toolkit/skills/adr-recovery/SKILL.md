...
- Template: `ai-sdlc-toolkit/templates/adr.md` (use `Status: Discovered`)
- Reference: `ai-sdlc-toolkit/samples/assessments/edi-express/adrs/001-osdu-on-aws-r3m25.md`
...
1. **Read the template** at `ai-sdlc-toolkit/templates/adr.md`. Understand every `<!-- AGENT: ... -->` and `<!-- REPLACE: ... -->` block — these are authoring rules, not text to copy.
...
- `ai-sdlc-toolkit/samples/assessments/edi-express/adrs/001-osdu-on-aws-r3m25.md` — Discovered ADR format, rationale from code + Jira + runbook, Consequences describing the migration motivation
