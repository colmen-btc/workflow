...
- Template: `ai-sdlc-toolkit/templates/system-overview.md`
...
1. **Read the template** at `ai-sdlc-toolkit/templates/system-overview.md`. Every `<!-- AGENT: ... -->` block is an authoring rule. Every `<!-- REPLACE: ... -->` block is a fill target. These are not text to copy.
